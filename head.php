<section class="page-header display-scroll" >
            ...
            <div class="head_leftside">
                ...
                <div class="middle-contents">
                    ...
                    <div class="title-small">
                        ...
                        <a href="#">Click to see the chapters</a>

                        <div class="cb-h1">
                            <div class="p_chapters">success stories from all around the globe.</div>
                            <div class="h1_chapters"><a href="#"></a>Chapters</div>
                        </div>
                    </div>
                <div>
            <div class="head_rightside">
