...
<div class="intro-header section-content">
    <div class="intro-leftside">
        ...
        <div class="intro-small1">
            <strong>A crowdfunding platform for special taletns.</strong>
            <br>
            <br>
            Connecting talents and masters from all around the globe.
        </div>
    
        <div class="exprenaiton-wrap">
            <div class="exprenation" id="chage_exprenation">
                <p>
    ...
    <div class="intro-rightside">
        <div class="spinsroll">
            <p class="spinsrollp">SPIN'S<strong>ROLES</strong></p>
            <div class="line1"></div>
        </div>
        <div class="introBtns">
